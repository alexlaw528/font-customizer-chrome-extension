...
&emsp; <img src='./assets/manage_extensions.png' width=40% height=40%>

3. Click the "Load unpacked" button and select the cloned repository

&emsp; <img src='./assets/load_unpacked.png' width=40% height=40%>

4. Toggle Extension to begin updating your fonts. Pin the extension to your browser for quick future access!

&emsp; <img src='./assets/toggle_extension.png' width=40% height=40%>